        ...
        <html>
            ...
            <body>
                <div id="header">
                    ...
                    <h2 id="pageName">Implementation - Real Time Issues</h2> 
                  </div>
                    <div id="navbar"> 
                      <div id="sectionLinks">                         
                        <ul> 
                ...
                <div id="subnavbar"> 
                        <li><a href="#CodeLevelCompatibility">Code Level Compatibility</a></li>
                        <li><a href="#ArchitecturalLevelCompatibility">Architectural Level Compatibility</a></li>
                </div> 
                <div id="content">
