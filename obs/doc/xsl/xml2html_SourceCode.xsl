        ...
        <html>
            ...
            <body>
                <div id="header">
                    ...
                    <h2 id="pageName">Implementation - Source Code</h2> 
                  </div>
                    <div id="navbar"> 
                      <div id="sectionLinks">                         
                        <ul> 
                ...
                <div id="subnavbar"> 
                        <li><a href="#CppCodeOrganization">Cpp Code Organization</a></li>
                        <li><a href="#CppCodeDocumentation">Cpp Code Documentation</a></li>    
                        <li><a href="#XSLCodeOrganization">XSL Code Organization</a></li>   
                        <li><a href="#XSLCodeDocumentation">XSL Code Documentation</a></li>   
                </div> 
                <div id="content">
