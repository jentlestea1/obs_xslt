        ...
        <html>
            ...
            <body>
                <div id="header">
                    ...
                    <h2 id="pageName">Implementation - Implementation Issues</h2> 
                  </div>
                    <div id="navbar"> 
                      <div id="sectionLinks">                         
                        <ul> 
                ...
                <div id="subnavbar"> 
                        <li><a href="#MemoryOccupation">Memory Occupation</a></li>
                        <li><a href="#ByteOrdering">Byte Ordering</a></li>    
                        <li><a href="#AlignmentConstraints">Alignment Constraints</a></li>
               </div> 
                <div id="content">
