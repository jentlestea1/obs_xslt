...
<xsl:text/>
            <xsl:for-each select=".//*[@kind='property'][@name]">
                  <xsl:text>   </xsl:text><xsl:value-of select="$man"/>->set<xsl:value-of select="@name"/>(<xsl:value-of select="@value"/>);
<xsl:text/>
            </xsl:for-each>
...
<xsl:text/>
            ...
            <xsl:text>   </xsl:text><xsl:value-of select="$man"/>->setTelecommandLoader(<xsl:value-of select="$tcLoader"/>);
...
<xsl:text/>
            <xsl:for-each select=".//*[@kind='property'][@name]">
                  <xsl:text>   </xsl:text><xsl:value-of select="$tcLoader"/>->set<xsl:value-of select="@name"/>(<xsl:value-of select="@value"/>);
<xsl:text/>
            </xsl:for-each>
            
            <!-- Load the telemetry manager -->
            <xsl:text>   </xsl:text><xsl:value-of select="$tcLoader"/>->setTelecommandManager(<xsl:value-of select="$TcMan"/>);
...
<xsl:text/>
            ...
            <xsl:text>   </xsl:text><xsl:value-of select="$man"/>->setTelemetryStream(<xsl:value-of select="$tmStream"/>);
<xsl:text/>
            ...
            <xsl:text>   </xsl:text><xsl:value-of select="$man"/>->setTelemetryModeManager(<xsl:value-of select="$tmModMan"/>);
<xsl:text/>
...
<xsl:text/>
            <xsl:for-each select=".//*[@kind='property'][@name]">
                  <xsl:text>   </xsl:text><xsl:value-of select="$tmStream"/>->set<xsl:value-of select="@name"/>(<xsl:value-of select="@value"/>);
<xsl:text/>
            </xsl:for-each>
...
<xsl:text/>
            <xsl:for-each select="//PUSTelemetryModeManager/*[@kind='property'][@name]">
                  <xsl:text>   </xsl:text><xsl:value-of select="$tmModMan"/>->set<xsl:value-of select="@name"/>(<xsl:value-of select="@value"/>);
<xsl:text/>
            </xsl:for-each>
