...
TD_InstanceId CC_RootObject::systemListSize = 0;
TD_InstanceId CC_RootObject::instanceCounter = 0;
DC_EventRepository* CC_RootObject::pEventRepository = pNULL;
DataPool* CC_RootObject::pDataPool = pNULL;
ParameterDatabase* CC_RootObject::pParameterDatabase = pNULL;
Tracer* CC_RootObject::pTracer = pNULL;
CC_RootObject** CC_RootObject::pSystemList = pNULL;
