...
#ifndef DC_SampleR1Database_incH
#define DC_SampleR1Database_incH

#include "../GeneralInclude/BasicTypes.h"


const TD_DatabaseId DB_K1 = 1;
const TD_DatabaseId DB_K2 = 2;
const TD_DatabaseId DB_K3 = 3;
const TD_DatabaseId DB_K4 = 4;
