...
TestCaseSampleFullDataPool_1::TestCaseSampleFullDataPool_1():
      TestCaseWithEvtCheck(ID_SAMPLEFULLDATAPOOL*10+1,"TestCaseSampleFullDataPool_1") {
            return;
}

void TestCaseSampleFullDataPool_1::runTestCase() {
