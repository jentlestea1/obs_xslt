...
#ifndef TestCaseSampleMonitoredDataPool_1H
#define TestCaseSampleMonitoredDataPool_1H

#include "../Utilities/TestCaseWithEvtCheck.h"

/**
 * Check the functionalities implemented by the
 * <code>DC_SampleMonitoredDataPool</code> component.
 ...
 * @version 1.0
 */
class TestCaseSampleMonitoredDataPool_1 : public TestCaseWithEvtCheck {

  public :

     /**
      * Set the identifier and the name of the test case to: 
      * ID_SAMPLEMONITOREDDATAPOOL*10+1 and "TestCaseSampleMonitoredDataPool_1".
      */
