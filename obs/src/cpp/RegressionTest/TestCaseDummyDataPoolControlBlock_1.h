...
#ifndef TestCaseDummyDataPoolControlBlock_1H
#define TestCaseDummyDataPoolControlBlock_1H
 ...
 * @version 1.0
 */
class TestCaseDummyDataPoolControlBlock_1 : public TestCaseWithEvtCheck {
public:
	/**
