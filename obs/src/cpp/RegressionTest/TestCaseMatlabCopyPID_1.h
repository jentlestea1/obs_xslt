...
//
// TestCaseMatlabCopyPID_1.h
//
// Version	1.0
// Date		30.05.03 (Version 1.0)
// Author	R. Totaro

#ifndef TestCaseMatlabCopyPID_1H
#define TestCaseMatlabCopyPID_1H
 ...
 *
 * @see DC_MatlabCopyPID
 * @author Roberto Totaro
 * @version 1.0
 */
class TestCaseMatlabCopyPID_1 : public TestCaseGenericSetUp {
public:
     /**
      * Set the identifier and the name of the test case to, respectively,
      * ID_MATLABCOPYPID*10+1 and "TestCaseMatlabCopyPID_1".
      */
     TestCaseMatlabCopyPID_1(void);
