...
TestCasePUSMemoryLoadAbsolute_1::TestCasePUSMemoryLoadAbsolute_1(void) :
	TestCaseWithEvtCheck(ID_PUSMEMORYLOADABSOLUTE*10+1,"TestCasePUSMemoryLoadAbsolute_1") {
		return;
}

void TestCasePUSMemoryLoadAbsolute_1::runTestCase(void) {

   DC_PUSMemoryLoadAbsolute* pML = new DC_PUSMemoryLoadAbsolute();
   ...
   if ( (pML->getClassId() != ID_PUSMEMORYLOADABSOLUTE) )
